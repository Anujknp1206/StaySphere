                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                        <div
                                            style="margin-bottom: 10px;display:flex; flex-wrap: wrap; justify-content: end;">

                                            <div class="ml-auto">
                                                <a href="{{ route('teams.create') }}" class="btn btn-success">+ Add Team
                                                    Member</a>
                                            </div>
                                        </div>
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach($teams as $team)
                                            <tr>
                                                ...
                                                <td>{{ $team->email }}</td>
                                                <td>{{ $team->phone }}</td>
                                                <td><a href="{{ $team->webaddress }}"
                                                        target="_blank">{{ $team->webaddress }}</a>
                                                </td>
                                                ...
                                                <td><a href="https://wa.me/{{ $team->whatsapp }}" target="_blank">WhatsApp</a>
                                                </td>
                                                <td>
                                                    ...
                                                    <form action="{{ route('teams.destroy', $team->id) }}"
                                                        data-confirm-delete="true" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
