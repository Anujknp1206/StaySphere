            ...
            <div class="card-body">
                <form action="{{ route('settings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @if($setting->logo)
                            <br>
                            <img src="{{ asset('storage/photos/' . $setting->logo) }}" width="100" alt="Current Logo">
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="office1" name="office1"
                            value="{{ old('office1', $setting->office1) }}">
                    </div>

                    <div class="form-group">
                        <label for="office2">Office 2</label>
                        <input type="text" class="form-control" id="office2" name="office2"
                            value="{{ old('office2', $setting->office2) }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="phone_no" name="phone_no"
                            value="{{ old('phone_no', $setting->phone_no) }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control" id="map_location" name="map_location"
                            value="{{ old('map_location', $setting->map_location) }}">
                    </div>
